...
Welcome to Library Carpentry! This series of introductory workshops on software skills for librarians was an exploratory programme funded by the Software Sustainability Institute and supported by [Software Carpentry](http://software-carpentry.org/) and City University London. Thanks also go to the British Library and the University of Sussex where James Baker, who developed the workshops, worked when he was setting this up and where he currently works currently. The aim is to create a set of tools the community can manage, support, enrich, and reuse as it sees fit. Periodically during the sessions we will collect anonymous feedback. All this will go into building this future vision for a community driven and supported set of tools that the library community can use to kick start their exploration of software skills.
